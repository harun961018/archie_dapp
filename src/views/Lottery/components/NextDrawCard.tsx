...
const NextDrawCard = () => {
  ...
  const { endTime, amountCollectedInArchieneko, userTickets, status } = currentRound
  ...
  const prizeInBusd = amountCollectedInArchieneko.times(cakePriceBusd)
      ...
      <>
        ...
        {prizeInBusd.isNaN() ? (
          ...
          <Balance
            ...
            textAlign={['center', null, null, 'left']}
            unit=" ARCHIE"
            value={getBalanceNumber(amountCollectedInArchieneko)}
            decimals={0}
          />
       )}
      </>
