    ...
    <StyledCardBody>
      ...
      <Grid>
        <Flex justifyContent={['center', null, null, 'flex-start']}>
          <Heading color="black" mb="24px">{t('Winning Number')}</Heading>
        </Flex>
        ...
        {userDataForRound && (
          <>
            <Box display={['none', null, null, 'flex']}>
              <Heading color="black">{t('Your tickets')}</Heading>
            </Box>
            <Flex
            ...
            >
              <Box mt={['32px', null, null, 0]}>
                <Text color="black" display="inline">{youHadText} </Text>
                <Text color="black" display="inline" bold>
                  {userDataForRound.totalTickets}
                </Text>
                <Text color="black" display="inline">{ticketsThisRoundText}</Text>
              </Box>
              <Button
