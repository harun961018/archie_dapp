...
export const processLotteryResponse = (
  ...
  const priceTicketInArchieneko = new BigNumber(priceTicketInArchienekoAsString)
  const amountCollectedInArchieneko = new BigNumber(amountCollectedInArchienekoAsString)
