...
import archienekoAbi from 'config/abi/archieneko.json'
...
export const getArchienekoContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(archienekoAbi, tokens.archieneko.address, signer)
}
